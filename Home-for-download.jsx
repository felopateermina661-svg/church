...
function Home() {
  ...
  <button
    onClick={() => navigate("/SundaySchool")}
      className="mt-7 inline-flex items-center gap-2 bg-[#1A2744] hover:bg-[#243654] text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 font-se[...]
      >
        اعرف المزيد
          <ArrowLeft size={20} />
          </button>
